...
export type { Payment } from "./contracts/PaymentsSolDec082022.sol/Payment";
export { Payment__factory } from "./factories/contracts/PaymentsSolDec082022.sol/Payment__factory";
